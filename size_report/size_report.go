...
func getMemoryRegion(elfFilePath string, mapFile string, sectionName string) (*MemoryRegion,
	error) {
...
func SizeReport(elfFilePath, mapFile, srcBase string, sectionName string, diffFriendly bool) error {
	...
	sectionRegion, err := getMemoryRegion(elfFilePath, mapFile, sectionName)
	if err != nil {
		return err
	}
